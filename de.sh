...
function exitscr(){
 clear
 echo Your Desktop Environment $VER - 2020-2022. Russanandres
 date
 exit
}
function loading() {
...
echo
echo ⠀⠀⠀┌──────────────────────────────────────────────────────────────────────────────────────────────────────┐
echo ⠀⠀ │YDE Installation⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀[part 2 of 2]⠀│
echo ⠀⠀⠀└──────────────────────────────────────────────────────────────────────────────────────────────────────┘
echo
echo
...
echo
echo ⠀⠀⠀┌──────────────────────────────────────────────────────────────────────────────────────────────────────┐
echo ⠀⠀ │YDE reInstallation⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀[part 1 of 1]⠀│
echo ⠀⠀⠀└──────────────────────────────────────────────────────────────────────────────────────────────────────┘
echo
echo
echo ⠀⠀⠀⠀⠀⠀Hello!
...
echo
echo ⠀⠀⠀┌──────────────────────────────────────────────────────────────────────────────────────────────────────┐
echo ⠀⠀ │YDE deInstallation⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀[part 1 of 3]⠀│
echo ⠀⠀⠀└──────────────────────────────────────────────────────────────────────────────────────────────────────┘
echo
echo
echo ⠀⠀⠀⠀⠀⠀Hello!
...
echo
echo ⠀⠀⠀┌──────────────────────────────────────────────────────────────────────────────────────────────────────┐
echo ⠀⠀ │YDE deInstallation⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀[part 2 of 3]⠀│
echo ⠀⠀⠀└──────────────────────────────────────────────────────────────────────────────────────────────────────┘
echo
echo
...
echo
echo ⠀⠀⠀┌──────────────────────────────────────────────────────────────────────────────────────────────────────┐
echo ⠀⠀ │YDE deInstallation⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀[part 3 of 3]⠀│
echo ⠀⠀⠀└──────────────────────────────────────────────────────────────────────────────────────────────────────┘
echo
echo
...
echo
echo ⠀⠀⠀┌──────────────────────────────────────────────────────────────────────────────────────────────────────┐
echo ⠀⠀ │YDE Installation⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀[part 1 of 3]⠀│
echo ⠀⠀⠀└──────────────────────────────────────────────────────────────────────────────────────────────────────┘
echo
echo
...
echo
echo ⠀⠀⠀┌──────────────────────────────────────────────────────────────────────────────────────────────────────┐
echo ⠀⠀ │YDE Installation⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀[part 2 of 3]⠀│
echo ⠀⠀⠀└──────────────────────────────────────────────────────────────────────────────────────────────────────┘
echo
echo
...
echo $(sudo apt install ncal dialog -y) >> /dev/null
sleep 2
kill "$!"
...
echo
echo ⠀⠀⠀┌──────────────────────────────────────────────────────────────────────────────────────────────────────┐
echo ⠀⠀ │YDE Installation⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀[part 3 of 3]⠀│
echo ⠀⠀⠀└──────────────────────────────────────────────────────────────────────────────────────────────────────┘
echo
echo
